  ...
  return <header id="header">
    ...
    <div className="header-inner">
      ...
      <ul>
        ...
        <li><Link className={path.indexOf('components') === -1 ? '' : 'current'} to="/rax-map/components/about"><Icon type="appstore-o"/><span>组件文档</span></Link></li>
        <li><a href="https://github.com/ElemeFE/rax-amap" target="_blank"><Icon type="github"/><span>GitHub</span></a></li>
        <li>
